...
const citPlace = document.getElementById("citation");
const authPlace = document.getElementById("auteur");
const btnNew = document.getElementById("nouveau");
...
btnNew.addEventListener("click", () => {
  do {
    nombreAleatoire = genererNombreEntier(citation.length);
  } while (nombreAleatoire == dernier);

  citPlace.textContent = citation[nombreAleatoire][0];
  authPlace.textContent = citation[nombreAleatoire][1];
